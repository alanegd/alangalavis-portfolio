    ...
    <section id="about" className={`${styles.about}  mt-5 p-10 md:px-20 items-center md:flex justify-between`}>
      <div>
        <div className="flex flex-col md:flex-row justify-center mb-8 text-center items-center">
          ...
          <h2 className="md:mx-10 mb-2 font-semibold text-4xl md:text-4xl text-[#172432] uppercase whitespace-nowrap">Acerca de mí</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 text-[#172432]">
          ...
          <div className="md:w-1/4 flex flex-col items-center">
            ...
            <a className="py-3 w-full text-white text-center bg-[#E25A27] hover:bg-[#FA652E] cursor-pointer shadow-md" href="/CV - Alan Galavis.pdf" target="_blank" rel="noopener noreferrer">Descargar CV</a>
          </div>
        </div>
      </div>
    </section>
