...
export default function AboutSection() {
  return (
    <section id="about" className={`${styles.about}  mt-5 p-10 md:px-20 items-center md:flex justify-center`}>
      <div>
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="md:w-1/4 flex flex-col items-center">
            ...
            <a class="py-3 w-full text-white text-center bg-[#ec5f4d] hover:bg-[#ff7c67] rounded-b cursor-pointer" href="/" download>Descargar CV</a>
          </div>
        </div>
      </div>
