...
export default function HeroSection() {
  ...
  return (
    <section className="md:my-16 items-center md:flex justify-center overflow-x-clip bg-[#22312E] md:pb-32">
      <div className={`${styles.hero} md:px-20 py-10 text-center text-[#D9D4C1] md:text-left items-center relative`} data-aos="fade-up" data-aos-duration="1000">
        <div className="md:flex items-center relative">
          ...
          <div className="hidden md:block md:w-1/2 absolute top-1/2 right-0 transform -translate-y-1/2">
            <img src={heroImageSVG} alt="alanegd" className="" />
          </div>
        </div>

        <hr className="w-32 h-0.5 bg-[#D9D4C1] border-0 hidden md:block" />
