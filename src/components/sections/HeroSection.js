...
export default function HeroSection() {
  ...
  return (
    <section className="md:mt-14 items-center md:flex justify-center overflow-x-clip bg-[#22312E] md:pb-[136px]">
      <div
        className={`${styles.hero} md:px-20 py-10 text-center text-[#F3EED8] md:text-left items-center relative`}
      >
        <div data-aos="fade-up" data-aos-duration="1000">
          <div className="md:flex items-center relative">
            <div className="md:w-1/2 flex flex-col justify-center">
              ...
              <p className="py-4 hidden md:block">
                Ingeniero de software especializado en proyectos full stack y
                frameworks ágiles.
              </p>
            </div>

            <div className="hidden md:block md:w-1/2 absolute top-1/2 right-0 transform -translate-y-1/2">
              <img src={heroImageSVG} alt="alanegd" loading="lazy" />
            </div>
          </div>
          ...
          <div className="flex py-4 items-center justify-center md:justify-start">
            <a
              href="https://www.linkedin.com/in/alan-galavis/"
              className="text-3xl text-[#F3EED8] hover:text-[#172432]"
              target="_blank"
            ...
            <a
              href="https://github.com/alanegd"
              className="text-3xl text-[#F3EED8] hover:text-[#172432] ms-5"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
            ...
            <a
              href="mailto:alangalavisjobs@gmail.com"
              className="text-3xl text-[#F3EED8] hover:text-[#172432] ms-5"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Email"
